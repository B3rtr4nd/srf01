...
int main(int argc, char **argv)
{
	...
	char *portName = "/dev/ttyUSB0";					// Name of the UART port on the Raspberry pi
...
int getStatus(int fd) {
	...
	//int status = serialBuffer[0] & 0x01;
	int status = serialBuffer[0];
